...
export default function Profile() {
  ...
  return (
    <SidebarWithHeader>
      <Box p="2" maxW='1120px' m='auto' mb={4}>
        ...
        <Flex justify="space-between" mt="10" direction={{ base: 'column', md: 'row' }}>
          <Box flexGrow={1} mt={ 4 }>
            <Heading as='h3' fontSize={{ md: 'lg' }} fontWeight='500'>
              Dados gerais
            </Heading>
            <Text color='gray.500'>
          ...
          <Box maxW='2xl' flexGrow={3} bg={useColorModeValue('white', 'gray.700')} rounded='md' p={ 4 } mt={ 4 }>
            <Box>
        ...
        <Flex justify="space-between" mt="10" direction={{ base: 'column', md: 'row' }}>
          <Box flexGrow={1} mt={ 4 }>
            ...
            <Text color='gray.500' wordBreak="break-word">
